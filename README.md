...
1. **Update Root `README.md`**:
   ...
   - Add/update the model run in the appropriate table matching the model scale/version (e.g. YOLOv8 Nano, YOLOv8 Small, YOLOv26 Nano, or YOLOv26 Small) under that dataset section.
